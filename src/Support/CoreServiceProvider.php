...
use \Neomerx\Core\Api\Inventory\Inventory;
...
use \Neomerx\Core\Api\Facades\Inventory as InventoryFacade;
...
class CoreServiceProvider extends ServiceProvider
{
    ...
    {
        // up to 'src' dir
        $resourceDir = __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR .
    ...
    private function registerApiFacades()
    {
        ...
        $this->app->bind(InventoryFacade::INTERFACE_BIND_NAME, Inventory::BIND_NAME);
