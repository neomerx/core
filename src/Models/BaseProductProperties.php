...
/**
 * @property int         id_base_product_property
 ...
 */
class BaseProductProperties extends BaseModel
{
    /** Model table name */
    const TABLE_NAME = 'base_product_properties';
    ...
    /** Model field name */
    const FIELD_ID                = 'id_base_product_property';
    /** Model field name */
